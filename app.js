(function () {
  ...
  const defaultState = {
    members: [
      ...
      {
        key: "adultLeisureTraining",
        label: "Adultes loisir + entraînement",
        count: 20,
        fee: 135,
        federal: 33.57,
        territorial: 29.75,
    ...
    shuttle: {
      ...
      freePlayBoxPrice: 35,
      youthTrainingBoxesPerWeek: 3,
      youthTrainingBoxPrice: 29,
    },
    training: {
  ...
  const storageKey = "bcv38-financial-simulator-v9";
